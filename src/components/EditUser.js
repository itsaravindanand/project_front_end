            ...
            <form onSubmit={handleSubmit}>
                <div className="form-group">
                    ...
                    <input
                        ...
                        value={username}
                        disabled
                        style={{ background: '#e9ecef', color: '#495057', borderWidth: 5, borderColor: '#ccc' }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        style={{ borderWidth: 5, borderColor: firstName ? 'green' : 'red' }}
                    />
                </div>
                <div className="form-group">
                    ...
                    <input
                        ...
                        style={{ borderWidth: 5, borderColor: lastName ? 'green' : 'red' }}
                    />
                </div>
                <div className="form-group">
                    <label>
                    ...
                    <input
                        ...
                        style={{ borderWidth: 5, borderColor: updateEmail ? (validEmail ? 'green' : 'red') : '#ccc' }}
                    />
                </div>
                <div className="form-group">
                    <label>
                    ...
                    <select
                        ...
                        style={{ borderWidth: 5, borderColor: updateUserType ? 'blue' : '#ccc' }}
                    >
                ...
                <div className="form-group">
                    ...
                    {updatePassword && (
                        <input
                            ...
                            style={{ borderWidth: 5, borderColor: validPwd ? 'green' : 'red' }}
                        />
                    )}
                </div>
